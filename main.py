...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            text = "=" * 25 + "[ MENU ]" + "=" * 25
            print(f"{Fore.GREEN}  [01]: Increase Money {Fore.YELLOW}           1.500")
            print(f"{Fore.GREEN}  [02]: Increase Coins {Fore.YELLOW}           4.500")
            print(f"{Fore.GREEN}  [03]: King Rank {Fore.YELLOW}                8.000")
            print(f"{Fore.GREEN}  [04]: Change ID {Fore.YELLOW}                4.500")
            print(f"{Fore.GREEN}  [05]: Change Name {Fore.YELLOW}              100")
            print(f"{Fore.GREEN}  [06]: Change Name (Rainbow) {Fore.YELLOW}    100")
            print(f"{Fore.GREEN}  [07]: Number Plates {Fore.YELLOW}            2.000")
            print(f"{Fore.GREEN}  [08]: Account Delete {Fore.YELLOW}           FREE")
            print(f"{Fore.GREEN}  [09]: Account Register {Fore.YELLOW}         FREE")
            print(f"{Fore.GREEN}  [10]: Delete Friends {Fore.YELLOW}           500")
            print(f"{Fore.GREEN}  [11]: Unlock Paid Cars {Fore.YELLOW}         5.000")
            print(f"{Fore.GREEN}  [12]: Unlock all Cars {Fore.YELLOW}          6.000")
            print(f"{Fore.GREEN}  [13]: Unlock all Cars Siren {Fore.YELLOW}    3.500")
            print(f"{Fore.GREEN}  [14]: Unlock w16 Engine {Fore.YELLOW}        4.000")
            print(f"{Fore.GREEN}  [15]: Unlock All Horn {Fore.YELLOW}s         3.000")
            print(f"{Fore.GREEN}  [16]: Unlock Disable Damage {Fore.YELLOW}    3.000")
            print(f"{Fore.GREEN}  [17]: Unlock Unlimited Fuel {Fore.YELLOW}    3.000")
            print(f"{Fore.GREEN}  [18]: Unlock House 3 {Fore.YELLOW}           4.000")
            print(f"{Fore.GREEN}  [19]: Unlock Smoke {Fore.YELLOW}             4.000")
            print(f"{Fore.GREEN}  [20]: Unlock Wheels {Fore.YELLOW}            4.000")
            print(f"{Fore.GREEN}  [21]: Unlock Animations {Fore.YELLOW}        2.000")
            print(f"{Fore.GREEN}  [22]: Unlock Equipaments M {Fore.YELLOW}     3.000")
            print(f"{Fore.GREEN}  [23]: Unlock Equipaments F {Fore.YELLOW}     3.000")
            print(f"{Fore.GREEN}  [24]: Change Race Wins {Fore.YELLOW}         1.000")
            print(f"{Fore.GREEN}  [25]: Change Race Loses {Fore.YELLOW}        1.000")
            print(f"{Fore.GREEN}  [26]: Clone Account {Fore.YELLOW}            7.000")
            print(f"{Fore.GREEN}  [27]: Custom HP {Fore.YELLOW}                2.500")
            print(f"{Fore.GREEN}  [28]: Custom Angle {Fore.YELLOW}             1.500")
            print(f"{Fore.GREEN}  [29]: Custom Tire burner {Fore.YELLOW}       1.500")
            print(f"{Fore.GREEN}  [30]: Custom Car Millage {Fore.YELLOW}       2.000")
            print(f"{Fore.GREEN}  [31]: Custom Car Brake {Fore.YELLOW}         2.000")
            print(f"{Fore.GREEN}  [00] Exit Tools")
            text = "=" * 58
            print(Colorate.Horizontal(Colors.yellow_to_green,(text)))
