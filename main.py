...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            text = "=" * 25 + "[ MENU ]" + "=" * 25
            print(Colorate.Horizontal(Colors.yellow_to_green,(text)))
            print(f"[01]: Increase Money {Fore.YELLOW}           1.500")
            print(f"[02]: Increase Coins {Fore.YELLOW}           4.500")
            print(f"[03]: King Rank {Fore.YELLOW}                8.000")
            print(f"[04]: Change ID {Fore.YELLOW}                4.500")
            print(f"[05]: Change Name {Fore.YELLOW}              100")
            print(f"[06]: Change Name (Rainbow) {Fore.YELLOW}    100")
            print(f"[07]: Number Plates {Fore.YELLOW}            2.000")
            print(f"[08]: Account Delete {Fore.YELLOW}           FREE")
            print(f"[09]: Account Register {Fore.YELLOW}         FREE")
            print(f"[10]: Delete Friends {Fore.YELLOW}           500")
            print(f"[11]: Unlock Paid Cars {Fore.YELLOW}         5.000")
            print(f"[12]: Unlock all Cars {Fore.YELLOW}          6.000")
            print(f"[13]: Unlock all Cars Siren {Fore.YELLOW}    3.500")
            print(f"[14]: Unlock w16 Engine {Fore.YELLOW}        4.000")
            print(f"[15]: Unlock All Horn {Fore.YELLOW}s         3.000")
            print(f"[16]: Unlock Disable Damage {Fore.YELLOW}    3.000")
            print(f"[17]: Unlock Unlimited Fuel {Fore.YELLOW}    3.000")
            print(f"[18]: Unlock House 3 {Fore.YELLOW}           4.000")
            print(f"[19]: Unlock Smoke {Fore.YELLOW}             4.000")
            print(f"[20]: Unlock Wheels {Fore.YELLOW}            4.000")
            print(f"[21]: Unlock Animations {Fore.YELLOW}        2.000")
            print(f"[22]: Unlock Equipaments M {Fore.YELLOW}     3.000")
            print(f"[23]: Unlock Equipaments F {Fore.YELLOW}     3.000")
            print(f"[24]: Change Race Wins {Fore.YELLOW}         1.000")
            print(f"[25]: Change Race Loses {Fore.YELLOW}        1.000")
            print(f"[26]: Clone Account {Fore.YELLOW}            7.000")
            print(f"[27]: Custom HP {Fore.YELLOW}                2.500")
            print(f"[28]: Custom Angle {Fore.YELLOW}             1.500")
            print(f"[29]: Custom Tire burner {Fore.YELLOW}       1.500")
            print(f"[30]: Custom Car Millage {Fore.YELLOW}       2.000")
            print(f"[31]: Custom Car Brake {Fore.YELLOW}         2.000")
