...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            text = "=" * 25 + "[ MENU ]" + "=" * 25
            print(Colorate.Horizontal(Colors.yellow_to_green,(text)))
            print(f"[01]: Increase Money         1.500")
            print(f"[02]: Increase Coins         4.500")
            print(f"[03]: King Rank              8.000")
            print(f"[04]: Change ID              4.500")
            print(f"[05]: Change Name            100")
            print(f"[06]: Change Name (Rainbow)  100")
            print(f"[07]: Number Plates          2.000")
            print(f"[08]: Account Delete         FREE")
            print(f"[09]: Account Register       FREE")
            print(f"[10]: Delete Friends         500")
            print(f"[11]: Unlock Paid Cars       5.000")
            print(f"[12]: Unlock all Cars        6.000")
            print(f"[13]: Unlock all Cars Siren  3.500")
            print(f"[14]: Unlock w16 Engine      4.000")
            print(f"[15]: Unlock All Horns          3.000")
            print(f"[16]: Unlock Disable Damage  3.000")
            print(f"[17]: Unlock Unlimited Fuel  3.000")
            print(f"[18]: Unlock House 3         4.000")
            print(f"[19]: Unlock Smoke           4.000")
            print(f"[20]: Unlock Wheels          4.000")
            print(f"[21]: Unlock Animations      2.000")
            print(f"[22]: Unlock Equipaments M   3.000")
            print(f"[23]: Unlock Equipaments F   3.000")
            print(f"[24]: Change Race Wins       1.000")
            print(f"[25]: Change Race Loses      1.000")
            print(f"[26]: Clone Account          7.000")
            print(f"[27]: Custom HP              2.500")
            print(f"[28]: Custom Angle           1.500")
            print(f"[29]: Custom Tire burner     1.500")
            print(f"[30]: Custom Car Millage     2.000")
            print(f"[31]: Custom Car Brake       2.000")
